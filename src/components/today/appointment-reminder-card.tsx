...
const useStyles = makeAccentStyles(b => ({
  card: {
    backgroundColor: brandTint(b.fill, 0.07),
    borderWidth: 1,
    borderColor: brandTint(b.fill, 0.2),
    borderLeftWidth: 3,
    borderLeftColor: b.text,
    borderRadius: 12,
    paddingVertical: 14,
  ...
  pressed: { opacity: 0.7 },
  days: { fontSize: 13, fontWeight: '600', color: b.text, marginBottom: 3 },
  date: { fontSize: 14, color: '#c8d0e0', marginBottom: 6 },
  link: { fontSize: 12, color: b.fillAlt },
}));
